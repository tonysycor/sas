...
$blobSasToken = New-AzStorageAccountSASToken  -Permission $sasPermissions -ExpiryTime $sasExpiry  -Context (New-AzStorageContext -StorageAccountName $storageAccountName)
